...
from converter_image_to_image import (
    ImageToImage,
)  # импорт класса скрипта конвертера форматов картинок
from sound_converter import (
    SoundConverter,
)  # импорт класса скрипта конвертера форматов звуков
from video_converter import (
    VideoConverter,
)  # импорт класса скрипта конвертера форматов видео
